...
test('10 remaining damage, 1 stack', () => {
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 1, { remainingDamage: 10 });
    char.statusEffectManager.turnEnd();
    expect(char.currentHealth).toBe(90);
});

test('20 remaining damage, 2 stacks', () => {
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 2, { remainingDamage: 20 });
    char.statusEffectManager.turnEnd();
    expect(char.currentHealth).toBe(90);
    char.statusEffectManager.turnEnd();
...
test('10 + 20 remaining damage, 1 + 1 stacks', () => {
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 1, { remainingDamage: 10 });
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 1, { remainingDamage: 20 });
    char.statusEffectManager.turnEnd();
...
test('20 + 30 remaining damage, 2 + 1 stacks', () => {
    ...
    char.statusEffectManager.turnEnd();
    expect(char.currentHealth).toBe(90);
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 1, { remainingDamage: 30 });
    char.statusEffectManager.turnEnd();
    expect(char.currentHealth).toBe(70);
});

test('0 remaining damage, 1 stack', () => {
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 1, { remainingDamage: 0 });
    char.statusEffectManager.turnEnd();
    expect(char.currentHealth).toBe(100);
});

test('0 remaining damage, 3 stack', () => {
    char.statusEffectManager.addDebuff(DebuffId.Bleeding, char, 3, { remainingDamage: 0 });
    char.statusEffectManager.turnEnd();
    expect(char.currentHealth).toBe(100);
});